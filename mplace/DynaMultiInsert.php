...
class DynaMultiInsert extends ZInsert
{
    ...
    public function run()
    {
        ...
        $this->model->id = 130;
        $this->model->sort = null;
        $this->model->name = 'Новая запись 130';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        $this->model->active = 1;
        ...
        $this->model->id = 142;
        $this->model->sort = null;
        $this->model->name = 'Новая запись 142';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        $this->model->active = 1;
        ...
        $this->model->id = 144;
        $this->model->sort = null;
        $this->model->name = 'Новая запись 144';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        $this->model->active = 1;
        ...
        $this->model->id = 145;
        $this->model->sort = null;
        $this->model->name = 'Новая запись 145';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        $this->model->active = 1;
        $this->model->dyna_config_id = 698;
        $this->model->dynaId = 'ShopOrder-/shop/complect/no-complect/index';
        $this->model->group = 'and';
        $this->model->models = 'ShopOrder';
        $this->model->operator = '=';
        ...
        $this->model->id = 147;
        $this->model->sort = null;
        $this->model->name = 'Новая запись 147';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        $this->model->active = 1;
