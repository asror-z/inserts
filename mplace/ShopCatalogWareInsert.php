...
class ShopCatalogWareInsert extends ZInsert
{
    ...
    public function run()
    {
        ...
        $this->model->shop_catalog_id = 12358;
        $this->model->ware_id = 59;
        $this->model->best_before = '2022-01-01';
        ...
        $this->model->shop_catalog_id = 12408;
        $this->model->ware_id = 61;
        $this->model->best_before = '2020-10-04';
        $this->model->amount = 4;
        $this->save();
